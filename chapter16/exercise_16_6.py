...
titles = [x['properties']['title'] for x in all_eq_dicts ]
...
fig = px.scatter(data, x='经度', y='纬度', size = '震级',size_max=10, color = '震级', color_continuous_scale='mygbm', title = title, labels = labels, hover_name= '位置')
